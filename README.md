# nonsense - Windows Enhancement Utility 🚀

**nonsense** is a C# application designed to debloat, optimize and customize your Windows experience. From software management to system optimizations and customization, nonsense provides everything you need to enhance Windows 10 and 11 systems.
...
- Create autounattend.xml files based on your nonsense selections

### Other Settings 
- Manage Your nonsense (and Windows) Settings with Wihance Configuration Files:
   - Save settings currently applied in nonsense to a config file for easy importing on a new system or after a fresh Windows install.
- Toggle nonsense's theme (Light/Dark Mode)

## Feedback and Community

If you have feedback, suggestions, or need help with nonsense, please join the discussion on GitHub or our Discord community:

[![Join the Discussion](https://img.shields.io/badge/Join-the%20Discussion-2D9F2D?style=for-the-badge&logo=github&logoColor=white)](https://github.com/o9-9/nonsense/discussions)
[![Join Discord Community](https://img.shields.io/badge/Join-Discord%20Community-5865F2?style=for-the-badge&logo=discord&logoColor=white)](https://www.discord.gg/GvsbHUgKT3)
